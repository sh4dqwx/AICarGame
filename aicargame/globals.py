...
WINDOW_WIDTH = 600
WINDOW_HEIGHT = 1000
PLAYER_START = Vector2(WINDOW_WIDTH / 2, WINDOW_HEIGHT * 0.9)
PLAYER_SIZE = Vector2(WINDOW_WIDTH * 0.2, WINDOW_HEIGHT * 0.2)
PLAYER_VELOCITY = 10
ENEMY_START_SIZE = Vector2(WINDOW_WIDTH / 20, WINDOW_HEIGHT / 20)
ENEMY_MAX_SIZE = Vector2(WINDOW_WIDTH * 0.2, WINDOW_HEIGHT * 0.2)
ENEMY_SPEED = 4
ENEMY_INTERVAL = (5, 30)
